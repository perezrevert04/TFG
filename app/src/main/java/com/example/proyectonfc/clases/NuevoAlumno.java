...
public class NuevoAlumno extends AppCompatActivity {
    ...
    private EditText numeroAlumnos;
    private int count = 0;
            ...
            public void onClick(View v) {
                ...
                try {
                    if (identificador==null || nombre == null) {
                        ...
                        dataBase.agregarAlumno(asignatura + toDec(identificador), dni, nombre);
                        Toast.makeText(getApplicationContext(), "ALUMNO AGREGADO CORRECTAMENTE", Toast.LENGTH_SHORT).show();
                        intent.putExtra("ASIGNATURA", asignatura );
                    }
                }catch (Exception e){
                    AlertDialog.Builder builder = new AlertDialog.Builder(NuevoAlumno.this);
                    builder.setTitle("El alumno con Identificador: "+ toDec(identificador)+" ya está dado de alta.");
                    builder.setMessage("");
...
/*****************************************************FIN ESCANER QR*****************************************************************/
    ...
    private String dumpTagData(Tag tag) {
        ...
        byte[] id = tag.getId();
        sb.append("Alumno con Nº de identificación: ").append(toDec(id)).append('\n');
